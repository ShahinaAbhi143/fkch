...
GEMINI_API_KEY = None
try:
    from BrandrdXMusic.config import GEMINI_API_KEY as Configured_GEMINI_API_KEY
    if Configured_GEMINI_API_KEY:
        GEMINI_API_KEY = Configured_GEMINI_API_KEY
        print("DEBUG: Gemini.py: GEMINI_API_KEY loaded from BrandrdXMusic.config.")
    else:
        print("DEBUG: Gemini.py: GEMINI_API_KEY in config.py was None or empty.")
except ImportError:
    print("DEBUG: Gemini.py: Could not import GEMINI_API_KEY from BrandrdXMusic.config.")
